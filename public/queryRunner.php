...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    switch ($queryType) {
        case "r6a":
            $sql = "
                SELECT ur.r_id AS report_id, ur.occurence_date AS occurred_at, ul.location_type AS location_name, 'user' AS source
                FROM userReports ur
        ...
        case "r6b":
            $sql = "
                SELECT pr.r_id AS report_id, pr.occurence_date AS occurred_at, pl.location_type AS location_name, 'police' AS source
